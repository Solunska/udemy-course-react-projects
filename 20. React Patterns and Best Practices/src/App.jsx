        ...
        <Accordion.Item id="experience" className="accordion-item">
          ...
          <Accordion.Content className="accordion-item-content">
            <article>
              ...
              <p>We are in the business of planning highly individualized vecation trips for more than 20 years.</p>
            </article>
          </Accordion.Content>
        </Accordion.Item>
        <Accordion.Item id="local-guides" className="accordion-item">
          ...
          <Accordion.Content className="accordion-item-content" >
            <article>
              ...
              <p>Instead, we are working with local guides to ensure a safe and pleasant vecation</p>
            </article>
          </Accordion.Content>
        </Accordion.Item>
      </Accordion>
